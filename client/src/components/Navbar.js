...
const Navbar = (props) => {
    ...
    return (
        <div id="nav">
            <div className="noClick" style={{alignItems: 'center', color: '#000', backgroundColor: '#fff', border: '1px solid #ddd', borderRadius: '4px', display: 'inline-flex', fontFamily: 'Lato, sans-serif', fontSize: '14px', fontWeight: 600, height: '30px', justifyContent: 'center', textDecoration: 'none', padding: '0px 10px'}}>
